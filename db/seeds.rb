...
applebees = Restaurant.create(name: "Applebee's", info: "Applebee's is an American Family Restaurant that serves Steaks, Burgers, Hamburgers, and Salads. Most have a bar that serves alcolic beverages.", category: "American", photo_url: "https://upload.wikimedia.org/wikipedia/en/thumb/b/bc/Applebee's.svg/1280px-Applebee's.svg.png")
bennigans = Restaurant.create(name: "Bennigans", info: "Bennigan's is an Irish pub-themed casual dining restaurant with a focus on focus on the food, drinks and Irish Hospitality.", category: "Irish", photo_url: "https://upload.wikimedia.org/wikipedia/commons/2/26/Bennigan's_logo.png")
...
chipotle = Restaurant.create(name: "Chipotle", info: "Chipotle Mexican Grill, Inc. is a chain of fast food restaurants in the United States, United Kingdom, Canada, Germany, and France, specializing in Mission burritos and tacos.", category: "Tex-Mex", photo_url: "https://upload.wikimedia.org/wikipedia/en/thumb/3/3b/Chipotle_Mexican_Grill_logo.svg/1024px-Chipotle_Mexican_Grill_logo.svg.png")
